...
//callback will be called when the message has been sent
function udpSend(socket, message, rawUrl, callback=(err)=>{if(err)	console.log(`An error occured: ${err}`); else console.log('Data sent to the address');}) {
